...
postman.setEnvironmentVariable("utils", () => {
    ...
    var createIssueObject = (obj) => {
        ...
        createProjectOverview(returnedObj);
        return returnedObj;
    }
    ...
    var timeKeeper = (obj) => {
        // console.log(obj);
        // console.log(obj.fields.customfield_1012);
        // console.log(Object.keys(obj.fields.customfield_10122).length);
        // console.log(Object.keys(obj.fields.customfield_10122));
        ...
        // console.log("  startDate: "+startDate+" - "+(obj.fields.customfield_11221 !== null));
        ...
        // console.log("  dueDate: "+dueDate+" - "+(obj.fields.duedate !== null));
        ...
        // console.log("  targetStartDate: "+targetStartDate+" - "+(obj.fields.duedate !== null));
        ...
        // console.log("  targetEndDate: "+targetEndDate+" - "+(obj.fields.customfield_11420 !== null));

        // console.log("  endDate: "+obj.fields.customfield_11378+" - "+(obj.fields.customfield_11378 !== null));
        ...
        // console.log("  endDate: "+endDate+" - "+(obj.fields.customfield_11378 !== null));

        let updated = (obj.fields.updated !== "null") ? moment(obj.fields.updated.substring(0, 10), "YYYY-MM-DD").format("YYYY-MM-DD") : now;
        // console.log("  updated: "+updated+" - "+(obj.fields.updated !== null));

        let lastViewed = (obj.fields.lastViewed !== "null") ? moment(obj.fields.lastViewed, "YYYY-MM-DD").format("YYYY-MM-DD") : now;
        // console.log("  lastViewed: "+lastViewed+" - "+(obj.fields.lastViewed !== null));

        // let tdObj = JSON.stringify({ created: created, startDate: startDate, dueDate: dueDate, targetStartDate: targetStartDate, targetEndDate: targetEndDate, endDate: endDate, updated: updated, lastViewed: lastViewed });
        let tdObj = {
            created: created,
            startDate: startDate,
            dueDate: dueDate,
